...
pub use dokan_sys::{
	...
	DOKAN_IO_SECURITY_CONTEXT as IO_SECURITY_CONTEXT, DOKAN_MAJOR_API_VERSION as MAJOR_API_VERSION,
	DOKAN_NP_NAME as NP_NAME, DOKAN_PRODUCT_VERSION as PRODUCT_VERSION,
	DOKAN_PROFILE_HASH_HEX as PROFILE_HASH_HEX, DOKAN_RUNTIME_DLL_NAME as RUNTIME_DLL_NAME,
